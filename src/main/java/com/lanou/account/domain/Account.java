...
public class Account {
    ...
    private String recommender_idcard;

    public String getRecommender_idcard() {
        return recommender_idcard;
    }

    public void setRecommender_idcard(String recommender_idcard) {
        this.recommender_idcard = recommender_idcard;
    }
